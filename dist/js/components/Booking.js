...
class Booking{
    ...
    getData(){
        ...
        .then(function([bookings, eventsCurrent, eventsRepeat]){
            ...
            //console.log('bookings events current', eventsCurrent);
            //console.log('bookings event repeat', eventsRepeat);
    ...
    initTables(target) {
        ...
        if (target.classList.contains(classNames.booking.table)) {
          const tableNumber = parseInt(target.getAttribute('data-table'));
    
          // check if table is free
          if (!target.classList.contains(classNames.booking.tableBooked)) {
    
            // remove class selected if any exist
            const selectedTable = thisBooking.bookingContainer.querySelector(`.${classNames.booking.tableSelected}`);
            if (selectedTable) {
              selectedTable.classList.remove(classNames.booking.tableSelected);
            }
    
            // add class selected to target table
